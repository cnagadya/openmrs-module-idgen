                            ...
                            <form>
                                ...
                                <fieldset>
                                    <div className="col-sm-6 col-md-4">
                                        ...
                                        <Input type="select" id="source"  name="source" onChange={this.handleSearch} >
                                    ...
                                    <div className="col-sm-6 col-md-4">
                                        ...
                                        <Input id="gen_by" name="generatedBy" onChange={this.handleGeneratedByChange}/>
                                    </div>
                                    <div className="col-sm-6 col-md-4">
                                ...
                                <div className="btn-group" role="group">
                                    <input
                                        ...
                                        <input type="reset" className="col-sm-6 cancelbtn" value="Reset"/>
                                </div>
                            </form>
                        </div>}</div>
