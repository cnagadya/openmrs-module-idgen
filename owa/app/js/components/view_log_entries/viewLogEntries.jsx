...
export default class LogEntries extends React.Component {
    ...
    advancedSearch() {
        ...
        if (!this.state.startDate){
            apiCall(null, 'get', `/idgen/logentry?v=full&identifier=${identifier}&comment=${comment}&source=${source}&generatedBy=${generatedBy}&toDate=${endDate}`).then((response) => {
            this.setState({logEntries: response.results});
        });
        }
        else{ 
            ...
            <div className="logwrapper">
                ...
                <div className="logs_table_area">
                    ...
                    <div className="table-responsive logs_table">
                        { (this.state.searchFilters.source || this.state.searchFilters.identifier || this.state.searchFilters.generatedBy || this.state.searchFilters.comment || this.state.startDate|| this.state.dateChanged)  &&
